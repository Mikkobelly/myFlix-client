        ...
        <>
            <Card border="light" className="bg-light bg-opacity-75">
                <Card.Body className="p-3 p-md-5">
                    <Card.Title className="mb-3 fw-bold fs-2">{user.Username}</Card.Title>
                    <Card.Text>
                    ...
                    <Card.Text>
                        <span className="me-1 fw-semibold">Favorite Movies: </span>
                    </Card.Text>
                    <Container>
                        <Row>
                ...
                <div id="collapse-form">
                    <Form onSubmit={handleEditSubmit} className="p-4 bg-light bg-opacity-75 rounded">
                        ...
                        <Form.Group className="my-3" controlId="formUsername">
                            ...
                            <Form.Control className="bg-light" type="text" placeholder={user.Username} value={username} onChange={e => setUsername(e.target.value)} required minLength="5" />
                        </Form.Group>
